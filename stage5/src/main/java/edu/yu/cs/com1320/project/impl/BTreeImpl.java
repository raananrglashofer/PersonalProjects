...
//        }
    ...
    public void moveToDisk(Key k) throws Exception {
        if( k == null){
            throw new NoSuchElementException(); // I believe this is correct based off Piazza 271_f1
        }
        // find the value in the Btree and check if null
        Value v = this.get(k);
        if(v == null){
    ...
    private static boolean less(Comparable k1, Comparable k2) // can i have static methods like this
    {
